...
export function useAuthSession(options: Omit<UseQueryOptions<AuthSession>, "queryKey" | "queryFn"> = {}) {
  return useQuery({ queryKey: AUTH_SESSION_QUERY_KEY, queryFn: getAuthSession, retry: false, ...options });
}
