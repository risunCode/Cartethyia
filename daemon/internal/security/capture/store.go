...
// Error is a package-owned, machine-readable capture failure.
type Error struct {
	Code ErrorCode
	Err  error
}
...
var (
	ErrDisabled       = &Error{Code: CodeDisabled, Err: errors.New("capture disabled")}
	ErrLimit          = &Error{Code: CodeLimit, Err: errors.New("capture limit exceeded")}
	ErrSensitive      = &Error{Code: CodeSensitive, Err: errors.New("sensitive payload rejected")}
	ErrRedaction      = &Error{Code: CodeRedaction, Err: errors.New("payload redaction failed")}
	ErrCancelled      = &Error{Code: CodeCancelled, Err: context.Canceled}
	ErrAudit          = &Error{Code: CodeAudit, Err: errors.New("capture audit failed")}
	ErrInvalidConfig  = &Error{Code: CodeInvalidConfig, Err: errors.New("invalid capture configuration")}
	ErrProviderOptOut = &Error{Code: CodeProviderOptOut, Err: errors.New("provider opted out of capture")}
	ErrOutOfScope     = &Error{Code: CodeOutOfScope, Err: errors.New("capture is outside configured scope")}
)
