...
func (r *routeRequestDetail) Overview(context.Context, TelemetryQuery) (TelemetryOverview, error) {
	return TelemetryOverview{}, nil
}

func (r *routeRequestDetail) Requests(context.Context, TelemetryQuery) ([]TelemetryBucket, error) {
	return nil, nil
}

func (r *routeRequestDetail) Errors(context.Context, TelemetryQuery) ([]TelemetryBucket, error) {
	return nil, nil
}

func (r *routeRequestDetail) Upstream(context.Context, TelemetryQuery) ([]TelemetryBucket, error) {
	return nil, nil
}

func (r *routeRequestDetail) RequestDetail(_ context.Context, id string) (RequestDetail, error) {
	r.lastID = id
	if r.err != nil {
		return RequestDetail{}, r.err
	}
	return r.reply, nil
}
...
func TestRequestDetailHandlerReturnsBoundedDetail(t *testing.T) {
	...
	store := &routeRequestDetail{reply: RequestDetail{
		ID:           "42",
		TraceID:      "trace-42",
		Model:        "gpt-test",
		Provider:     "openai",
...
// after RequestDetail was added. Embedding the existing stub lets the missing
...
func (routeTelemetryConforms) RequestDetail(context.Context, string) (RequestDetail, error) {
