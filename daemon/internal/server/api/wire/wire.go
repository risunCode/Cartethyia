...
func writeBody(ctx context.Context, w http.ResponseWriter, body apicontracts.StreamReader) error {
...
func writeSSE(ctx context.Context, w http.ResponseWriter, body apicontracts.StreamReader) error {
...
func abortStream(body apicontracts.StreamReader, err error) {
