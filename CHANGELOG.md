...
- Console footer redesigned into a compact grid (2\u00d72 on mobile, single row on desktop): server-synced UTC and system-local clocks (not the browser's clock), and live uptime.
