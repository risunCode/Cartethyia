...
func ApplyThinking(targetSurface Surface, model string, body map[string]any, intent *ThinkingIntent) {
	...
	case SurfaceOpenAIChat, SurfaceOpenAIResponses:
		if intent.Mode == ModeNone {
			delete(body, "reasoning_effort")
	...
	if targetSurface != SurfaceAnthropic {
