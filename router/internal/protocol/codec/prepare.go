...
// NormalizeRequestSameSurface is the fast path for same-surface requests after
// bounded request preparation. It validates JSON well-formedness, extracts the
// model for routing, and returns the body unchanged — skipping the full
// decode/pipeline/encode cycle.
//
