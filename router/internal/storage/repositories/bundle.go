...
type Bundle struct {
	...
	TokenBudget router.TokenBudgetAuthority
...
func (b Bundle) WithTokenBudget(r router.TokenBudgetAuthority) Bundle {
	b.TokenBudget = r
	return b
}

// WithBatch returns a shallow copy with durable batch lifecycle storage set.
func (b Bundle) WithBatch(r BatchRepository) Bundle {
	b.Batch = r
	return b
}
