...
func TestKimchiRemainsAccessOnly(t *testing.T) {
	...
	_, err = driver.Refresh(context.Background(), RefreshTokenInput{ProviderID: "kimchi", AccountID: "fixture", RefreshToken: NewSecretFromString("refresh")})
	if err == nil {
