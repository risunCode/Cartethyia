...
type inFlightSnapshot struct {
	...
	Rows     []consolecontracts.InFlightRow `json:"rows,omitempty"`
}

func parseTelemetryQuery(r *http.Request) consolecontracts.TelemetryQuery {
	q := r.URL.Query()
	return consolecontracts.TelemetryQuery{
