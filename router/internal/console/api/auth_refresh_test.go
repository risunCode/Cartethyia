...
func (rotatingAuth) Login(_ context.Context, _ LoginInput, _ AuthRequest) (LoginResult, error) {
	return LoginResult{
		Session:   consolecontracts.Session{ID: "jti-1", User: "admin", Scopes: []string{"admin:*"}},
...
func (rotatingAuth) Current(_ context.Context, sessionID string) (consolecontracts.Session, error) {
	return consolecontracts.Session{ID: sessionID, User: "admin", Scopes: []string{"admin:*"}}, nil
}
func (rotatingAuth) Refresh(_ context.Context, sessionID string, _ AuthRequest) (LoginResult, error) {
	...
	return LoginResult{
		Session:   consolecontracts.Session{ID: "jti-2", User: "admin", Scopes: []string{"admin:*"}},
		SetCookie: "cartethyia_session=token-2; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400",
		MaxAge:    86400,
	}, nil
}
func (rotatingAuth) OAuthStart(context.Context, string, OAuthStartInput) (consolecontracts.OAuthState, error) {
	return consolecontracts.OAuthState{}, nil
}
func (rotatingAuth) OAuthComplete(context.Context, string, OAuthCompleteInput) (consolecontracts.OAuthState, error) {
	return consolecontracts.OAuthState{}, nil
}
func (rotatingAuth) OAuthCancel(context.Context, string) error { return nil }
func (rotatingAuth) OAuthRefresh(context.Context, OAuthRefreshInput) (consolecontracts.OAuthState, error) {
	return consolecontracts.OAuthState{}, nil
}
...
func TestRefreshRouteIssuesRotatedCookie(t *testing.T) {
	...
	var body struct {
		Data consolecontracts.Session `json:"data"`
	}
