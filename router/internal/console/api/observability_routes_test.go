...
func (routeConsoleLogs) List(context.Context, consolecontracts.ConsoleLogQuery) ([]consolecontracts.ConsoleLogEntry, error) {
	return []consolecontracts.ConsoleLogEntry{{ID: "event-1", Timestamp: "2026-08-13T10:00:00Z", Event: "incoming_request", Message: "bounded"}}, nil
}

func (routeConsoleLogs) Insert(context.Context, consolecontracts.ClientErrorInput) error { return nil }

type routeUsage struct{}

func (routeUsage) Usage(context.Context, consolecontracts.TelemetryQuery) (consolecontracts.UsageSummary, error) {
	return consolecontracts.UsageSummary{Requests: 1}, nil
}

func (routeUsage) Clients(context.Context, consolecontracts.TelemetryQuery) (consolecontracts.ClientDistribution, error) {
	return consolecontracts.ClientDistribution{Total: 1, Unknown: 1, Items: []consolecontracts.ClientUsageItem{{Client: "unknown", Count: 1, Percentage: 100}}}, nil
}

type routeCatalog struct{}

func (routeCatalog) Providers(context.Context) ([]consolecontracts.CatalogProvider, error) {
	return []consolecontracts.CatalogProvider{{ID: "openai", DisplayName: "OpenAI"}}, nil
}

type routeTelemetry struct {
	last consolecontracts.TelemetryQuery
}

func (t *routeTelemetry) Overview(context.Context, consolecontracts.TelemetryQuery) (consolecontracts.TelemetryOverview, error) {
	return consolecontracts.TelemetryOverview{Requests: 1}, nil
}

func (t *routeTelemetry) Requests(_ context.Context, input consolecontracts.TelemetryQuery) ([]consolecontracts.TelemetryBucket, error) {
	t.last = input
	return []consolecontracts.TelemetryBucket{{Timestamp: "2026-08-13T10:00:00Z", Count: 1}}, nil
}

func (t *routeTelemetry) Errors(context.Context, consolecontracts.TelemetryQuery) ([]consolecontracts.TelemetryBucket, error) {
	return nil, nil
}

func (t *routeTelemetry) Upstream(context.Context, consolecontracts.TelemetryQuery) ([]consolecontracts.TelemetryBucket, error) {
	return nil, nil
}

func (t *routeTelemetry) RequestDetail(context.Context, string) (consolecontracts.RequestDetail, error) {
...
func TestV2ObservabilityRoutesUseContractMethods(t *testing.T) {
	...
	tests := []struct {
		...
		{http.MethodPost, "/console/client-errors", `{"level":"error","message":"boom"}`, http.StatusNoContent},
