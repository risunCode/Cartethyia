...
func (testDashboard) Summary(context.Context) (consolecontracts.DashboardSummary, error) {
	return consolecontracts.DashboardSummary{Version: "test"}, nil
}
...
func (testSettings) Get(context.Context) (consolecontracts.RuntimeSettings, error) { return consolecontracts.RuntimeSettings{}, nil }
func (testSettings) Patch(context.Context, consolecontracts.RuntimeSettingsInput) (consolecontracts.RuntimeSettings, error) {
	return consolecontracts.RuntimeSettings{LogLevel: "info"}, nil
}
func (testSettings) Reset(context.Context) (consolecontracts.RuntimeSettings, error) { return consolecontracts.RuntimeSettings{}, nil }
