...
type ResponseEvidence = p.ResponseEvidence
type SafeResponseHeaders = p.SafeResponseHeaders
type FailureScope = p.FailureScope
type RepairProposal = p.RepairProposal
type RepairProposer = p.RepairProposer
...
const (
	...
	FailureScopeRoute            = p.FailureScopeRoute
	FailureScopeProvider         = p.FailureScopeProvider
	FailureScopeProxy            = p.FailureScopeProxy
	FailureScopeModel            = p.FailureScopeModel
	FailureScopeAccount          = p.FailureScopeAccount
	MaxResponseEvidenceBodyBytes = p.MaxResponseEvidenceBodyBytes
)

var Model = p.Model
var ModelWithUpstream = p.ModelWithUpstream
var HasCapability = p.HasCapability
var ClassifyResponseEvidence = p.ClassifyResponseEvidence
var NewResponseEvidence = p.NewResponseEvidence
var NewSafeResponseHeaders = p.NewSafeResponseHeaders
