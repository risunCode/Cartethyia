...
// the Cartethyia /v1 API surface. It is the gateway's public inbound contract
// seam so router and runtime packages can satisfy the interfaces without
// coupling handlers to concrete implementations.
