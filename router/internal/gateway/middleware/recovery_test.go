...
type captureLogger struct {
	telemetry.Logger // NopLogger semantics for unused levels; Error is captured.
	messages             []string
	fields               [][]telemetry.Field
}

func (c *captureLogger) Error(_ context.Context, msg string, fields ...telemetry.Field) {
...
func TestRecoveryLogsPanicWithStack(t *testing.T) {
	log := &captureLogger{Logger: telemetry.NopLogger()}
