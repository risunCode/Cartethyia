import type { ImageReference, ProxyRequest } from "../../../domain/contracts";
import { classifyImageReference, isProtocolError, narrowArray, narrowNumber, narrowObject, narrowString, normalizeFail, normalizeOk, protocolError, pushImageReference, MAX_IMAGE_COUNT, MAX_MODEL_LENGTH, MAX_TEXT_BLOCK_LENGTH, type NormalizeInput, type NormalizeResult, type ProtocolError } from "../../../domain/protocols";
