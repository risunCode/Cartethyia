...
export const TOOL_REGISTRY = {
  ...
  claude: {
    ...
    defaultModels: [
      ...
      { id: "haiku", name: "Claude Haiku", alias: "haiku", roleLabel: "Haiku family", roleKind: "secondary" },
      { id: "fable", name: "Claude Fable", alias: "fable", roleLabel: "Fable family", roleKind: "secondary" },
      { id: "mythos", name: "Claude Mythos", alias: "mythos", roleLabel: "Mythos family", roleKind: "secondary" },
    ],
  },
