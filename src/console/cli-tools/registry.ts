...
export const TOOL_REGISTRY = {
  ...
  claude: {
    ...
    defaultModels: [
      { id: "opus", name: "Claude Opus", alias: "opus", roleLabel: "Opus default", envKey: "ANTHROPIC_DEFAULT_OPUS_MODEL", defaultValue: "claude-opus-4-8" },
      { id: "sonnet", name: "Claude Sonnet", alias: "sonnet", roleLabel: "Sonnet default", roleKind: "primary", envKey: "ANTHROPIC_DEFAULT_SONNET_MODEL", defaultValue: "claude-sonnet-5" },
      { id: "haiku", name: "Claude Haiku", alias: "haiku", roleLabel: "Haiku default", roleKind: "secondary", envKey: "ANTHROPIC_DEFAULT_HAIKU_MODEL", defaultValue: "claude-haiku-4-5-20251001" },
      { id: "fable", name: "Claude Fable 5", alias: "fable", roleLabel: "Fable default", roleKind: "secondary", envKey: "ANTHROPIC_DEFAULT_FABLE_MODEL", defaultValue: "claude-fable-5" },
      { id: "mythos", name: "Claude Mythos 5", alias: "mythos", roleLabel: "Mythos model", roleKind: "secondary", envKey: "ANTHROPIC_DEFAULT_MODEL", defaultValue: "claude-mythos-5" },
    ],
  },
