...
export const blackboxaiConfig = {
  ...
  models: [
    ...
    modelOf("google/gemini-3.1-flash-lite", "Gemini 3.1 Flash Lite", capabilitiesOf({ surfaces: NATIVE_SURFACES, reasoning: true }), { upstreamId: "blackboxai/google/gemini-3.1-flash-lite" }),
    modelOf("google/gemini-3.5-flash", "Gemini 3.5 Flash", capabilitiesOf({ surfaces: NATIVE_SURFACES, reasoning: true }), { upstreamId: "blackboxai/google/gemini-3.5-flash" }),
    modelOf("google/gemma-4-31b-it", "Gemma 4 31B IT", capabilitiesOf({ surfaces: NATIVE_SURFACES, reasoning: true }), { upstreamId: "blackboxai/google/gemma-4-31b-it" }),
    modelOf("mistral/codestral", "Codestral", capabilitiesOf({ surfaces: NATIVE_SURFACES }), { upstreamId: "blackboxai/mistral/codestral" }),
    modelOf("moonshotai/kimi-k2.7-code", "Kimi K2.7 Code", capabilitiesOf({ surfaces: NATIVE_SURFACES, reasoning: true }), { upstreamId: "blackboxai/moonshotai/kimi-k2.7-code" }),
    ...
    modelOf("openai/gpt-oss-120b", "GPT-OSS 120B", capabilitiesOf({ surfaces: NATIVE_SURFACES, reasoning: true }), { upstreamId: "blackboxai/openai/gpt-oss-120b" }),
    modelOf("x-ai/grok-4.3", "Grok 4.3", capabilitiesOf({ surfaces: NATIVE_SURFACES, reasoning: true }), { upstreamId: "blackboxai/x-ai/grok-4.3" }),
    modelOf("x-ai/grok-build-0.1", "Grok Build 0.1", capabilitiesOf({ surfaces: NATIVE_SURFACES, reasoning: true }), { upstreamId: "blackboxai/x-ai/grok-build-0.1" }),
